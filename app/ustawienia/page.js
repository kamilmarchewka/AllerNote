  ...
  return (
    <section className="flex flex-col gap-5 pt-24 pb-10 lg:min-h-[calc(100vh-40px)]">
      ...
      <div className="py-5 px-4">
        <label className="text-gray-800 text-2xl font-bold block mb-2">Nazwa użytkownika</label>
      ...
      <div className="py-5 px-4">
        <label className="text-gray-800 text-2xl font-bold block mb-2">Email</label>
        <div className="relative flex items-center">
          <input
            name="email"
            type="text"
      ...
      <div className="py-5 px-4">
        <label className="text-gray-800 text-2xl font-bold block mb-2">Hasło</label>
        <div className="relative flex items-center">
          <input
            name="password"
            type="text"
      ...
      <div className="py-5 px-4">
        <label className="text-gray-800 text-2xl font-bold block mb-2">Województwo</label>
