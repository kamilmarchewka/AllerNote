  ...
  return (
    ...
    >
      ...
      <p className="text-gray-200 max-w-[30rem] text-center">
        Zobacz co pyli w konkretnym województwie lub stwórz darmowe konto i
        ciesz się pełnią możliwości AllerNote.
      </p>
      <div className="flex flex-row justify-around gap-10">
        <Link href="/alergeny" className="text-white underline pt-2">
          Lista pyłków
        </Link>
        <Link
          href="/login"
